...
output_folder = '/foundcog/forrestgump/foundcog-infants-2m/resmem_model/expanded_events/'
            ...
            if os.path.exists(resmem_file):
                ...
                if {'prediction', 'filename'}.issubset(resmem_df.columns):
                    ...
                    for i in range(0, len(pred_values), group_len):
                        ...
                        expanded_rows_list.append(pd.DataFrame([{"onset": onset, "duration": duration,
