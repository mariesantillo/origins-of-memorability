...
input_dir = "/foundcog/forrestgump/foundcog-infants-2m/resmem_vca_stranet_rsm_model/glm/beta_maps/averaged_beta_maps/"  
output_dir = "/foundcog/forrestgump/foundcog-infants-2m/resmem_vca_stranet_rsm_model/second_level/merged_beta_maps/"   

# List of contrasts to process
contrasts = ["resmem-prediction", "vca_entropy", "rsm_difference"]
