...
def merge_beta_maps(input_dir, output_dir, contrast_name):
    ...
    # Output file path
    output_file = os.path.join(output_dir, f"merged_{contrast_name}_4d_2.nii.gz")
...
input_dir = "/foundcog/forrestgump/foundcog-adult-2/resmem_stranet_vca_unscoredvideotest/glm/beta_maps/averaged_maps/"  
output_dir = "/foundcog/forrestgump/foundcog-adult-2/resmem_stranet_vca_unscoredvideotest/second_level/merged_beta_maps/"  

# List of contrasts to process
contrasts = ["resmem", "vca_entropy", 'rms_difference']
